...
. Foot must be in shoe. If foot not in shoe:
...
image::https://via.placeholder.com/600x400.png?text=Foot+in+shoe+with+laces+untied["Starting preconditions",600,400]
...
Hold the _**left** shoelace_ in the _**right** hand_ and the right shoelace in the left hand.Pull laces arrested by the thumb against the pointing finger.See image:

.Cross-hold shoelaces.
[#img-cross-hol-shoelaces,link=https://github.com/CaptainLugaru/MillsParkEngineeringShoelaceTying]
image::https://via.placeholder.com/400x300.png?text=Cross+hold_shoelaces["Cross-hold shoelaces",400,300]
...
Gide the tip of the lace that is on the top of the other and guide it through the hole formed by the shoe and 'the X' from the bottom to the top and over.See the formed outcome:
...
Pick the laces back up _by the middle_ and make the *_"Rabbit Ears"_*. See image:
...
Make an X with the rabbit ears, that now look like doubled laces, and gide the tip of the rabbit ears laces through the hole formed by the 'X' from the bottom to the top and over. See the formed outcome:
...
Carefully tighten the rabbit ears loop to form the durable tie. See the formed outcome:
...
====
It is important to mind the ends of the shoelaces to make sure that the tip is not accidentally pulled through the second loop breaking the rabbit ear. To remedy the situation one call pull the tip out slightly while the second loop is not fully tightened.
====
